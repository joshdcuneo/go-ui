...
import (
	...
	"github.com/joshdcuneo/go-ui/internal/validator"
)
...
func (app *application) userSignup(w http.ResponseWriter, r *http.Request) {
	...
	app.render(w, r, http.StatusOK, "user-signup", data)
}
...
func (app *application) userSignupPost(w http.ResponseWriter, r *http.Request) {
	...
	if !form.Valid() {
		data := app.newTemplateData(r)
		data.Form = form
		app.render(w, r, http.StatusUnprocessableEntity, "user-signup", data)
		return
	}
	...
	app.sessionManager.Put(r.Context(), string(authenticatedUserIDKey), id)
...
func (app *application) userLogin(w http.ResponseWriter, r *http.Request) {
	...
	app.render(w, r, http.StatusOK, "user-login", data)
}
...
func (app *application) userLoginPost(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		if errors.Is(err, models.ErrInvalidCredentials) {
			...
			data := app.newTemplateData(r)
			data.Form = form
			app.render(w, r, http.StatusUnprocessableEntity, "user-login", data)
		} else {
			app.serverError(w, r, err)
		}
		return
